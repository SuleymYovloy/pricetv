...
export const ItemCardNavCountry: FC<IItemCardNavCountry> = ({ countrImg, countProduct, countryCode, onClick }) => {
  ...
  return (
    ...
    >
      <img src={countrImg} alt={countrImg} style={{ width: '20px', height: '20px', marginBottom: '2px' }} />
      <span
        style={{
